#Esse comando faz que as tabelas não estejam mais relacionadas
#Fizemos isso para inserir dados
SET FOREIGN_KEY_CHECKS = 0;

#Metodo 1 de inserção
...
#Metodo 3 de inserção, em caso de estar fora de ordem
